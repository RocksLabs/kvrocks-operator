...
//+kubebuilder:rbac:groups=kvrocks.com,resources=kvrocks,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=kvrocks.com,resources=kvrocks/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=kvrocks.com,resources=kvrocks/finalizers,verbs=update
